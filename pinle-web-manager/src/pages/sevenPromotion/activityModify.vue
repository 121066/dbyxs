...
export default {
  ...
  methods: {
    ...
    get_detail(id) {
      this.$axios
        .post("/web_seven_promotion/get_promotion", "id=" + id)
        .then(result => {
          if (result.data.status == 0) {
            let data = result.data.data;
            this.form = data;
            this.goods.forEach(item => {
              item.msg = { picture: "", name: "", price: "", id: "" };
            });
            ...
            if (data.sevenPromotionShare) {
              ...
              this.form.lucky = data.lucky;

              data.sevenReward.forEach((item, index) => {
    ...
    update_activity() {
      ...
      this.$axios
        .post(
          "/web_seven_promotion/modify_promotion",
