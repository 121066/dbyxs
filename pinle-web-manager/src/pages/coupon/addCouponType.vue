<template>
  <div class="addcouponType-container">
    ...
    <div class="content">
      <el-main>
        ...
        <el-footer>
          <el-button type="primary" @click="add_couponType">确 定</el-button>
...
import { coupon_type_add } from "../../api/getData.js";
export default {
  ...
  methods: {
    ...
    add_couponType() {
      ...
      coupon_type_add(data).then(result => {
        if (result.data.status == 0) {
