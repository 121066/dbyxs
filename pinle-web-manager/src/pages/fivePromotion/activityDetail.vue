<template>
  <div class="fiveactivitydetail-container">
    <breadcrumb style></breadcrumb>
    <img
      src="../../img/return_icon.png"
      alt
      @click="$router.push('/fivePromotion_activitySettings')"
    >
    <div class="content">
      <el-main>
...
export default {
  ...
  methods: {
    get_detail() {
      this.$axios
        .post("/web_five_promotion/get_promotion", "id=" + this.id)
        .then(result => {
