  ...
  <div class="ten_add-container">
    ...
    <div class="content">
      <el-main>
        ...
        <el-footer>
          <el-button type="primary" @click="tenFree_add">确 定</el-button>
...
import { goods_detail, tFreeO_add } from "../../api/getData";
export default {
  ...
  methods: {
    ...
    tenFree_add(){
      ...
      var formData = {activityName:this.formData.actname,failureTime:this.formData.failureTime,goodsId:this.formData.goods.id,goodsPrice:this.formData.price,activityRules:activityRules}
      tFreeO_add(formData).then(res => {
