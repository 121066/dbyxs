<template>
  <div class="nComer_favor_add-container">
...
import {nc_favor_add} from '../../api/getData'
export default {
  ...
  methods: {
    ...
    add_promotion() {
      ...
      nc_favor_add('newPromotionSetVo=' + JSON.stringify(newPromotionSetVo)).then(res => {
