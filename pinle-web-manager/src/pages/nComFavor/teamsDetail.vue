<template>
  <div class="n_comer_favor_detail-container">
          ...
          <el-collapse-item title="拼团商品定制" name="2">
            <el-form label-width="120px" class="goods_select">
              <el-form-item label="目标商品">
                <div class="goods">
                  <img :src="goalGoods.picture" alt @click="$router.push('/goodsDetail?id=' + goalGoods.id)">
                  <div class="goods_msg">
              ...
              <el-form-item label="第一轮失败商品">
                <div class="goods">
                  <img :src="oneTimesGoods.picture" alt @click="$router.push('/goodsDetail?id=' + oneTimesGoods.id)">
                  <div class="goods_msg">
              ...
              <el-form-item label="第三轮失败商品">
                <div class="goods">
                  <img :src="threeTimesGoods.picture" alt @click="$router.push('/goodsDetail?id=' + threeTimesGoods.id)">
                  <div class="goods_msg">
              ...
              <el-form-item label="朋友邀请失败商品">
                <div class="goods">
                  <img :src="friendGoods.picture" alt @click="$router.push('/goodsDetail?id=' + friendGoods.id)">
                  <div class="goods_msg">
              ...
              <el-form-item label="第二轮失败商品">
                <div class="goods">
                  <img :src="twoTimesGoods.picture" alt @click="$router.push('/twoTimesGoods?id=' + friendGoods.id)">
                  <div class="goods_msg">
...
<style lang="less">
.n_comer_favor_detail-container {
  display: flex;
  flex-flow: column;
  height: 100%;
  position: relative;
