      ...
      <el-main>
        <el-collapse v-model="activeName">
          ...
          <el-collapse-item title="拼团用户" name="3">
            <el-form label-width="120px" style=" width: 360px;">
              <el-form-item label="拼团参与者">
                <div class="user" v-for="item in member" :key="item.id" style="border-radius:50%">
                ...
                <div class="user" style="line-height:50px;">
                  <span style="margin-left: 47px;color:#000;font-weight: 600">无人拼团</span>
                </div>
              </el-form-item>
            </el-form>
          </el-collapse-item>
          ...
          <el-collapse-item title="好友助力" name="5">
            <div class="user">
              <img :src="goalUser.picture" alt v-if="goalUser.picture" style="border-radius:50%" />
              <div class="user_msg">
                <p>{{goalUser.name}}</p>
...
export default {
  ...
  methods: {
    ...
    get_list() {
      this.$axios
        .post("/web_new_promotion/get_team_detail", "id=" + this.id)
        .then(result => {
