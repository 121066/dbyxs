      ...
      <el-main>
        <el-collapse v-model="activeName">
          ...
          <el-collapse-item title="晒单奖励" name="3">
            <el-form label-width="100px">
              <el-form-item label="点赞数量达" v-for="item in shareSetGoods" :key="item.helpNumber">
            ...
            <!-- <el-form label-width="100px" style="margin-left: 80px">
    ...
    get_detail() {
      this.$axios.post("/web_share/get", "id=" + this.id).then(result => {
        ...
        if (result.data.status == 0) {
          ...
          this.examineMessage = data.examineMessage;
