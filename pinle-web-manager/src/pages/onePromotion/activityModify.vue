      ...
      <el-main>
        <el-collapse v-model="activeName">
          ...
          <el-collapse-item title="拼团价格/人数制定" name="3">
            <el-form ref="form" :model="form" label-width="90px" class="assemble">
              ...
              <el-form-item label="最多购买次数">
                <el-input v-model="form.maxBuy"></el-input>
                <span>次</span>
              </el-form-item>
          ...
          <el-collapse-item title="晒单奖励" name="4">
            <div class="reward_goods" v-for="(item,index) in form.rewardList" :key="index" style="display: flex">
        ...
        .then(result => {
          if (result.data.status == 0) {
            if (result.data.data == 1) {
              ...
              this.$axios
                .post("/web_one_promotion/modify_share", { shares: data1,promotionId:this.id })
                .then(res => {
