<template>
  <div class="oneactivitydetail-container">
        ...
        <el-collapse v-model="activeName">
          ...
          <el-collapse-item title="拼团商品定制" name="2">
            <el-form label-width="120px" class="goods_select">
              ...
              <el-form-item label="失败商品" style="width: 250px;">
                <span style="color:#000; font-weight: 600;">{{failGoods.name}}</span>
              </el-form-item>
            </el-form>
          </el-collapse-item>
          <el-collapse-item title="拼团用户" name="3" class="promotion_user">
            <el-header>
              ...
              <el-form label-width="100px" style=" width: 360px;margin-left: 120px;">
                <el-form-item label="拼团胜出者">
                  <div class="user">
                    <img :src="winner.picture" alt>
                    <div class="user_msg">
                      <p class="ellipsis">  {{winner.name}}</p>
                      <p>{{winner.participateTime}}</p>
...
export default {
  ...
  data() {
    return {
      activeName: ["1", "3", "5"],
      usersList: [
        // {username: '爱拼团的程序员',joinTime: '2018-02-05 08:02:04', type:'机器人' },
        // {username: '爱拼团的程序员',joinTime: '2018-02-05 08:02:04', type:'机器人' },
        // {username: '爱拼团的程序员',joinTime: '2018-02-05 08:02:04', type:'机器人' },
        // {username: '爱拼团的程序员',joinTime: '2018-02-05 08:02:04', type:'机器人' },
        // {username: '爱拼团的程序员',joinTime: '2018-02-05 08:02:04', type:'机器人' },
      ...
      this.$axios
        ...
        .then(result => {
          ...
          if (result.data.status == 0) {
            ...
            if (this.winner) {
              if (this.winner.status == 0) {
                this.winner.status = "(机器人)";
              } else {
                this.winner.status = "(普通用户)";
              }
            } else {
              this.winner = {
                name: "",
